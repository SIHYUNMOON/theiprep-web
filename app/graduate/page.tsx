...
export default function GraduatePage() {
  useEffect(() => {
    const form = document.getElementById('graduate-contact-form') as HTMLFormElement
    const messageDiv = document.getElementById('graduate-form-message')
        ...
        <AnimatedSection className="py-24 px-6">
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {/* Card 1 */}
              <a href="/graduate-application" className="programs-card fade-up bg-[#5a6a84] border-none rounded-lg aspect-square flex flex-col p-8 cursor-pointer block">
              ...
              {/* Card 2 */}
              <div className="programs-card fade-up bg-[#3d5170] border-none rounded-lg aspect-square flex flex-col p-8">
                <h3 className="text-2xl font-semibold text-white mb-4" style={{ fontFamily: '"Noto Sans KR", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', fontWeight: 500 }}>
                  교정 서비스
                </h3>
                <div className="space-y-3 flex-1">
              ...
              {/* Card 3 */}
              <div className="programs-card fade-up bg-[rgb(13,37,99)] border-none rounded-lg aspect-square flex flex-col p-8">
                <h3 className="text-2xl font-semibold text-white mb-4" style={{ fontFamily: '"Noto Sans KR", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', fontWeight: 500 }}>
                  번역 서비스
                </h3>
                <div className="space-y-3 flex-1">
      ...
      <AnimatedSection className="relative py-24 px-6">
        ...
        <div className="container mx-auto max-w-3xl relative z-10">
          ...
          <div className="fade-up bg-white/95 backdrop-blur-sm rounded-lg shadow-2xl p-8 md:p-12">
            <form id="graduate-contact-form" className="space-y-6">
              ...
              <div id="graduate-form-message" className="hidden p-4 rounded-md"></div>
